                  ...
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="POST" action="/daftar-admin-edit"  enctype="multipart/form-data">
                      ...
                      <div class="col-md-6">
                        ...
                        @if($siswa->file_akta_kelahiran)
                            <p>File saat ini: 
                                <a href="{{ asset($siswa->file_akta_kelahiran) }}" target="_blank">Lihat Akta Kelahiran</a>
                            </p>
                        @endif
                        ...
                        @if($siswa->file_foto)
                            <img src="{{ asset($siswa->file_foto) }}" alt="Foto" style="max-width: 150px; max-height: 150px;">
                        @endif

                        <!-- File Imunisasi -->
                        <label for="file_imunisasi">File Imunisasi</label>
                        <input type="file" name="file_imunisasi" id="file_imunisasi" >
                        @if($siswa->file_imunisasi)
                            <p>File saat ini: 
                      ...
                      <div class="d-flex gap-3 justify-content-between">
                        <a href="{{ route('validation') }}" class="btn btn-secondary">Batal</a>
