        ...
        <div class="w-full bg-white rounded-lg shadow light:border md:mt-0 sm:max-w-md xl:p-0 light:bg-gray-800 light:border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="/register" method="POST">
                    @csrf
                    <div>
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 light:text-white">Nama</label>
                    ...
                    <p class="text-sm font-dark text-gray-500 light:text-gray-400">
                        Sudah memiliki akun? <a href="/login" class="font-medium text-primary-600 hover:underline light:text-primary-500">Masuk</a>
                    </p>
                </form>
            </div>
        </div>
